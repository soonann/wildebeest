const DesignBriefCard = (props: { startGame: any }) => {
    return (<div className=" grid grid-cols-5 p-5 space-y-6 mx-4 mb-5 ">
        <div className="h-52"></div>

        <div className=" animate-tilt col-span-5 md:col-span-5 lg:col-span-3  text-black mx-4 rounded-lg  bg-[url(/card-background.png)] bg-center bg-cover drop-shadow-[0_0px_10px_rgba(153,109,247,1)] ">
        ...
        <div className="col-span-5 pt-10 flex justify-center">
            <div>
